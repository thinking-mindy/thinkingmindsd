    ...
    >
      ...
      >
        ...
        >
          ...
          <Link color="text.secondary" variant="body2" href="/products?id=minds">
            Thinking Minds
          </Link>
          <Link color="text.secondary" variant="body2" href="/products?id=the-school">
            The School
          </Link>
          <Link color="text.secondary" variant="body2" href="/products?id=fulgul">
            Fulgul
          </Link>
          <Link color="text.secondary" variant="body2" href="/open-source">
            Free
          </Link>
      ...
      >
        ...
        >
          <IconButton
            color="inherit"
            size="small"
            href="https://github.com/thinking-mindy"
            aria-label="GitHub"
            sx={{ alignSelf: 'center' }}
          >
            <GitHubIcon />
          ...
          <IconButton
            color="inherit"
            size="small"
            href="www.linkedin.com/in/talent-chikamhi"
            aria-label="LinkedIn"
            sx={{ alignSelf: 'center' }}
          >
            <LinkedInIcon />
